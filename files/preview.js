function pullquote_preview_pop(plugPath,coreFile,styleFile) {
	var stylePath
	if (styleFile.substring(styleFile.length-4) != '.css') {
		stylePath = plugPath + 'styles/' + styleFile + '/pullquote.css';
	} else {
		stylePath = plugPath + 'styles/' + styleFile;
	}
	...
	varWinDoc.writeln('<link rel="stylesheet" href="' + plugPath + coreFile + '" type="text/css" />');

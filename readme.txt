...
Finally, go to the options panel, and on the Presentation/ Pull-Quotes screen, select your options.  The program works pretty well right out of the box.
...
Finally, Stephen Rider (that's me!) came along and added the options panel and all user changeable options, alternate text quotes, styles, etc.

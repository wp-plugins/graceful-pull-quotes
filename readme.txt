...
Finally, go to the Pull-Quotes settings panel, (under the "Design" tab), select your options.  This step is optional, as the program works pretty well right out of the box, but I recommend previewing the different quote styles at least.
...
BUG: WordPress does weird things if you try to put tags inside a comment.  See http://trac.wordpress.org/ticket/3603 for more info.

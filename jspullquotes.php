...
// TO DO: add "Settings" link to plugins page
...
// Add the configuration screen to the Presentation menu in Admin
	function optionspage() {
		...
		if ( function_exists('add_theme_page') ) {
			add_theme_page( $this->__('Customize Pull-Quotes'), $this->__('Pull-Quotes'), 'switch_themes', basename(__FILE__), array(&$this,'options_panel') );
		}
	}

...
// TO DO: turn these into user options:
		$this->style_path = $this->plugin_dir . '/styles';
		$this->style_url = $this->plugin_url . '/styles';

		load_plugin_textdomain( 'jspullquotes',
			'wp-content/plugins/' . basename( $this->plugin_dir ) . '/languages',
...
// Add action link(s) to plugins page
	...
	function add_ozh_adminmenu_icon( $hook ) {
		$icon = WP_CONTENT_URL . '/plugins/' . basename( dirname( __FILE__ ) ) . '/resources/menu_icon.png';
...
?>						</select>
					</label> (<a href="#" onclick="pullquote_preview_pop('<?php echo( $this->plugin_url ); ?>/resources', '<?php echo( $this->style_url ); ?>', document.getElementById('style').value); return false;" title="<?php $this->p_e( 'show a preview of the selected style in a pop-up window' ); ?>"><?php $this->p_e( 'preview' ); ?></a>)<br />
